...
- 2026-08-17 · HIRED · `competition-strategist` · closeout · #33, five-slide draft, independent of #154
- 2026-08-17 · HIRED · `ui-ux-designer` · closeout · spec for pulling back #25/#52/#56 from CUT, independent of #154
- 2026-08-17 · [batch, queued on unmerged PR #190] · #168 T2 (FUZZ/MINIMIZE, PR #188), T3 (CORRELATE, PR #186), T5 fix, T6 (EXPORT, PR #187 — cybersecurity BLOCKED on a real credential leak into the judge-downloaded evidence bundle, SEC-48/49 fixed, then a second CRITICAL found on re-review (SEC-50: `GET /evidence` bypassed all redaction), fixed at the source) all built and reviewed. #189 (no pinned fuzzing image) found via T2's review, filed, staffed — real fuzzing campaign confirmed the seeded vulnerability via genuine AddressSanitizer output.
- 2026-08-17 · HIRED · `backend-developer` · #168 T4-lite · PATCH_GENERATE executor, PR #196. Self-found and fixed a real D-028/C5 boundary risk (model gateway must never load in the ASGI process) before either reviewer had to catch it.
- 2026-08-17 · HIRED · `cto` · #189 · design brief (D-073) for FUZZ-execution topology — containerized worker has no docker CLI, D-036 forbids socket-mounting it in. Recommended a split worker fleet: bare-metal `fuzz-worker` for the finale demo, containerized sandbox-executor as a post-deadline fast-follow.
- 2026-08-17 · HIRED · `backend-developer` · #189 · implemented D-073 (PR #197) — kind-filtered `--kinds` claim loop, fail-closed default, import-boundary isolation test.
- 2026-08-17 · HIRED · `cybersecurity` · #189 · reviewed PR #197. Found SEC-50: Docker daemon access alone (which fuzz-worker has by design) lets a process join the backend network and reach the unauthenticated model-host directly — proved with real `docker` commands, not theorized.
- 2026-08-17 · HIRED · `cto` · #189 · ruling on SEC-50 (D-075): real fix required, not a risk acceptance — a bearer-token nginx sidecar in front of Ollama, since Ollama itself has no auth option.
- 2026-08-17 · HIRED · `devops-engineer` · #189 · implemented D-075 (PR #201) — real end-to-end verification the exact SEC-50 attack is now closed (connection refused on Ollama's real port from a network-joined container).
- 2026-08-17 · FOUND (via re-review) · SEC-51 · Docker daemon access itself (not just network access) trivially defeats the SEC-50 fix — `docker inspect`/`docker exec` gets the token or direct access for free. CTO ruled (D-077) this is a documented, accepted residual risk given the actual demo threat model (single host, single trusted operator, non-adversarial target) — not required to fix before 2026-08-20, explicitly not "fuzz-worker is now safe," only "the specific network-join attack is closed."
- 2026-08-17 · BLOCKED (external, ongoing) · GitHub Actions CI down repo-wide since ~09:00 — "recent account payments have failed or spending limit needs to be increased." All of #168 (7/7 executors) and #189 (fuzzing image, topology, auth fix) are fully built and reviewed, queued for merge the moment CI returns.
- 2026-08-17 · HIRED · `qa-engineer` × 6 · #168/#189 · independent test-suite review across every fully-cleared open PR (#186 T3, #192 fuzzing image, #196 T4, #175 T5, #201 model-host auth, #197 fuzz-worker topology) — per CEO instruction to add QA sign-off and harden the test suite ahead of the merge cascade.
